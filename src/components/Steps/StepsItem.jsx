...
function StepsItem({ index, profileHead, stepDetails }) {
  ...
  return (
    <div
      className={`relative flex items-center flex-col top-10 z-10 max-w-160 border rounded-xl p-4 transition-all ease-in-out duration-600 hover:scale-90 shadow-lg ${desktopPosition} `}
    >
